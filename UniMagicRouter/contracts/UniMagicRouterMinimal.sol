...
interface IFeeApprover {
    ...
    function setMagicVaultAddress(address _magicVaultAddress) external;
    ...
    function syncWithState(uint8) external returns (bool lastIsMint, bool lpTokenBurn);
...
contract UniMagicRouter /*is IUniswapV2Router02*/ {
    using SafeMath for uint;

    address public immutable /*override*/ factory = 0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f;
