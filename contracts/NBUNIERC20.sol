...
contract NBUNIERC20 is Context, INBUNIERC20, Ownable {
    ...
    function addLiquidityToUniswapMAGICxWETHPair() public {
    ...
    function _transfer(
        ...
        if(transferToFeeDistributorAmount > 0 && feeDistributor != address(0)){
            ...
            if(feeDistributor != address(0)){
                IMagicVault(feeDistributor).addPendingRewards(transferToFeeDistributorAmount);
            }
        }
    }
